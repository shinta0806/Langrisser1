...
一方のヴォルコフは、成長が望めない上に 5 章終了後に死亡してしまうため、育てる必要はありません。南東のアイテム回収後は暇しててもゲーム上は問題ありませんが、気分的な問題で、NPC を差し置いてゼルド達を迎撃しました。

レディンはロード隊を全滅させたら、光るマスを踏んでアイテム回収しつつ、ナームと合流してクリアします。南から攻め上げてくるマーマンは強めなので、テイラー隊に任せてしまって良いかと思います。
