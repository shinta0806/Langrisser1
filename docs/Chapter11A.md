...
|指揮官|クラス|兵種|傭兵|傭兵兵種|
|---|---|---|---|---|
|サー・ガリウス|セージ|僧侶|ファランクス|槍兵|
|ディスタン|ハイロード|歩兵|クルセイダー|僧侶|
|バレンツ|ハイランダー|騎兵|トルーパー|騎兵|
...
|---|---|---|---|---|---|---|
|4 ターン目|南|ランス|ハイランダー|騎兵|トルーパー|騎兵|
|6 ターン目|北西上空|ワイバーン（第三勢力）|ワイバーン|怪物飛|バット|怪物飛|
|6 ターン目|北東上空|ワイバーン（第三勢力）|ワイバーン|怪物飛|バット|怪物飛|

## 流れ

皇帝ディゴスを目指し、まずはダルシス城の下層に攻撃をかけるマップです。
...
第三勢力のワイバーンは敵味方関係なく、付近の部隊を襲います。

C ルートに進んだ場合、クリア後にランスが仲間になります。
...
C ルートに進むときは、ランスに対する殿（しんがり）を騎兵にして、階段でプロテクションを掛けてひたすら守りに徹し、時間を稼ぎます。
<div>
  <img src="../images/Chapter11A/RearGuard.jpg" width="25%">
</div>

その間にレディンが最上階に逃げ込みます。

ナーム隊で上空とサー・ガリウス周辺を制圧しておくとレディンの移動がスムーズですが、1 周目では難しいかもしれません。
